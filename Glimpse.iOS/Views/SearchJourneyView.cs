...
namespace Glimpse.iOS.Views
{
    public partial class SearchJourneyView : BaseView
    {
        ...
        private void AddPickerToTextField(UITextField textField, UIPickerView pickerView)
        {
            ...
            textField.Layer.BorderColor = GlimpseColors.BorderColor.CGColor;
        ...
        private UIToolbar CreateToolbar()
        {
            ...
            {
                TintColor = GlimpseColors.AccentColor
            };
        ...
        protected void UpdateUi()
        {
            ...
            calendarContainerView.Layer.BorderColor = GlimpseColors.BorderColor.CGColor;
