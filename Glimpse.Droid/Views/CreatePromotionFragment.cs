...
namespace Glimpse.Droid.Views
{
    ...
    public class CreatePromotionFragment : MvxFragment<CreatePromotionViewModel>
    {
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            ...
            Button acc_Button = view.FindViewById<Button>(Resource.Id.ContinuePart1Button);
        ...
        {
            string _firstName = view.FindViewById<EditText>(Resource.Id.promotionTitle).Text;
            string _email = view.FindViewById<EditText>(Resource.Id.promotionDescription).Text;
